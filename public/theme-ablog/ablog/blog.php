            ...
            <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                ...
                <div class="row pb-4">
                    ...
                    <div class="col-md-7 animate-box">
                        <a href="detail.php" class="fh5co_magna py-2"> Magna aliqua ut enim ad minim veniam quis
...
<div class="container-fluid pb-4 pt-5">
    <div class="container animate-box">
        <div>
            <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">Blog đọc nhiều</div>
        </div>
