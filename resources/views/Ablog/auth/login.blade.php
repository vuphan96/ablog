...
<div class="container-fluid mb-4">
    <div class="container">
        <div class="col-12 contact_margin_svnit ">
            <h2 class="fh5co_heading py-2">Đăng nhập</h2>
            @if (session('msg'))
            ...
            <div class="col-4 col-md-4">
                <form class="row" id="fh5co_contact_form" action="" method="POST">
                    ...
                    <div class="col-12 py-3 text-center">
                        <button class="btn contact_btn" type="submit">Đăng nhập</button>
                        <br><br>
                        <a style="color: #0091FF" href="{{route('Ablog.auth.register')}}">Đăng ký</a>
